...
public class Version1_18 extends NamedVersion {
	...
	public Version1_18() {
		...
		for (Server type : Arrays.asList(Server.SPAWN_ENTITY, Server.SPAWN_ENTITY_EXPERIENCE_ORB,
				Server.SPAWN_ENTITY_LIVING, Server.SPAWN_ENTITY_PAINTING, Server.SPAWN_PLAYER, Server.ADD_VIBRATION_SIGNAL, Server.ANIMATION,
				Server.STATISTIC, Server.BLOCK_CHANGED_ACK, Server.BLOCK_BREAK_ANIMATION, Server.TILE_ENTITY_DATA,
				...
				Server.UNLOAD_CHUNK, Server.GAME_STATE_CHANGE, Server.OPEN_WINDOW_HORSE, Server.INITIALIZE_BORDER,
				Server.KEEP_ALIVE, Server.LEVEL_CHUNK_LIGHT, Server.WORLD_EVENT, Server.WORLD_PARTICLES,
				Server.LIGHT_UPDATE, Server.LOGIN, Server.MAP, Server.OPEN_WINDOW_MERCHANT, Server.REL_ENTITY_MOVE,
				Server.REL_ENTITY_MOVE_LOOK, Server.REL_ENTITY_LOOK, Server.VEHICLE_MOVE, Server.OPEN_BOOK,
				Server.OPEN_WINDOW, Server.OPEN_SIGN_EDITOR, Server.PING, Server.AUTO_RECIPE, Server.ABILITIES,
				Server.COMBAT_END_EVENT, Server.COMBAT_ENTER_EVENT, Server.COMBAT_KILL_EVENT,
				...
				Server.MULTI_BLOCK_CHANGE, Server.SELECT_ADVANCEMENT_TAB, Server.SET_ACTION_BAR_TEXT,
				...
				Server.SCOREBOARD_DISPLAY_OBJECTIVE, Server.ENTITY_METADATA,
				...
				Server.STOP_SOUND, Server.PLAYER_LIST_HEADER_FOOTER, Server.NBT_QUERY,
