...
import com.elikill58.deps.yaml.snakeyaml.events.AliasEvent;
import com.elikill58.deps.yaml.snakeyaml.events.DocumentEndEvent;
import com.elikill58.deps.yaml.snakeyaml.events.DocumentStartEvent;
import com.elikill58.deps.yaml.snakeyaml.events.Event;
import com.elikill58.deps.yaml.snakeyaml.events.ImplicitTuple;
import com.elikill58.deps.yaml.snakeyaml.events.MappingEndEvent;
import com.elikill58.deps.yaml.snakeyaml.events.MappingStartEvent;
import com.elikill58.deps.yaml.snakeyaml.events.ScalarEvent;
import com.elikill58.deps.yaml.snakeyaml.events.SequenceEndEvent;
import com.elikill58.deps.yaml.snakeyaml.events.SequenceStartEvent;
import com.elikill58.deps.yaml.snakeyaml.events.StreamEndEvent;
import com.elikill58.deps.yaml.snakeyaml.events.StreamStartEvent;
import com.elikill58.deps.yaml.snakeyaml.reader.StreamReader;
import com.elikill58.deps.yaml.snakeyaml.scanner.Scanner;
import com.elikill58.deps.yaml.snakeyaml.scanner.ScannerImpl;
import com.elikill58.deps.yaml.snakeyaml.tokens.AliasToken;
import com.elikill58.deps.yaml.snakeyaml.tokens.AnchorToken;
import com.elikill58.deps.yaml.snakeyaml.tokens.BlockEntryToken;
import com.elikill58.deps.yaml.snakeyaml.tokens.DirectiveToken;
import com.elikill58.deps.yaml.snakeyaml.tokens.ScalarToken;
import com.elikill58.deps.yaml.snakeyaml.tokens.StreamEndToken;
import com.elikill58.deps.yaml.snakeyaml.tokens.StreamStartToken;
import com.elikill58.deps.yaml.snakeyaml.tokens.TagToken;
import com.elikill58.deps.yaml.snakeyaml.tokens.TagTuple;
import com.elikill58.deps.yaml.snakeyaml.tokens.Token;
import com.elikill58.deps.yaml.snakeyaml.util.ArrayStack;
		...
		public Event produce() {
			...
			if (!ParserImpl.this.scanner.checkToken(Token.ID.StreamEnd)) {
				...
				if (!ParserImpl.this.scanner.checkToken(Token.ID.DocumentStart)) {
					throw new ParserException(null, null, "expected '<document start>', but found " + ParserImpl.this.scanner.peekToken().getTokenId(),
		...
		public Event produce() {
			if (ParserImpl.this.scanner.checkToken(Token.ID.BlockEntry)) {
				...
				if (!ParserImpl.this.scanner.checkToken(Token.ID.BlockEnd)) {
					...
					throw new ParserException("while parsing a block collection", ParserImpl.this.marks.pop(), "expected <block end>, but found " + token2.getTokenId(),
							token2.getStartMark());
				}
