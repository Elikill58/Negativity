...
public class Version1_19_3 extends NamedVersion {
	...
	public Version1_19_3() {
		...
		for (Server type : Arrays.asList(Server.SPAWN_ENTITY, Server.SPAWN_ENTITY_EXPERIENCE_ORB, Server.SPAWN_PLAYER, Server.ANIMATION, Server.STATISTIC, Server.BLOCK_CHANGED_ACK,
				...
				Server.CUSTOM_PAYLOAD, Server.CHAT_DELETE, Server.KICK_DISCONNECT, Server.CHAT_DISGUISED, Server.ENTITY_STATUS, Server.EXPLOSION,
				...
				Server.REL_ENTITY_LOOK, Server.VEHICLE_MOVE, Server.OPEN_BOOK, Server.OPEN_WINDOW, Server.OPEN_SIGN_EDITOR, Server.PING, Server.AUTO_RECIPE, Server.ABILITIES, Server.CHAT,
				Server.COMBAT_END_EVENT, Server.COMBAT_ENTER_EVENT, Server.COMBAT_KILL_EVENT, Server.PLAYER_INFO_REMOVE, Server.PLAYER_INFO_UPDATE, Server.LOOK_AT, Server.POSITION,
