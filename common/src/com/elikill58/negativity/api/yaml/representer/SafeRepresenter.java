package com.elikill58.negativity.api.yaml.representer;
...
import com.elikill58.negativity.api.yaml.external.biz.base64Coder.Base64Coder;
...
class SafeRepresenter extends BaseRepresenter {
	...
	protected class RepresentString implements Represent {
		...
		public Node representData(final Object data) {
			...
			if (SafeRepresenter.this.defaultScalarStyle == null
					&& SafeRepresenter.MULTILINE_PATTERN.matcher(value).find()) {
				style = '|';
			}
	...
	protected class RepresentList implements Represent {
		@Override
		public Node representData(final Object data) {
			return SafeRepresenter.this.representSequence(SafeRepresenter.this.getTag(data.getClass(), Tag.SEQ),
					(Iterable<?>) data, null);
		}
	}
	...
	protected class RepresentMap implements Represent {
		@Override
		public Node representData(final Object data) {
			return SafeRepresenter.this.representMapping(SafeRepresenter.this.getTag(data.getClass(), Tag.MAP),
					(Map<?, ?>) data, null);
		}
	}
	...
	protected class RepresentSet implements Represent {
		...
		public Node representData(final Object data) {
			...
			return SafeRepresenter.this.representMapping(SafeRepresenter.this.getTag(data.getClass(), Tag.SET), value,
					null);
		}
	}
	...
	protected class RepresentDate implements Represent {
		...
		public Node representData(final Object data) {
			...
			if (data instanceof Calendar) {
				...
				calendar = Calendar
						.getInstance((SafeRepresenter.this.getTimeZone() == null) ? TimeZone.getTimeZone("UTC")
								: SafeRepresenter.this.timeZone);
			...
			int gmtOffset = calendar.getTimeZone().getOffset(calendar.get(0), calendar.get(1), calendar.get(2),
					calendar.get(5), calendar.get(7), calendar.get(14));
			if (gmtOffset == 0) {
				buffer.append('Z');
			} else {
				if (gmtOffset < 0) {
			...
			return SafeRepresenter.this.representScalar(SafeRepresenter.this.getTag(data.getClass(), Tag.TIMESTAMP),
	...
	protected class RepresentEnum implements Represent {
		...
		public Node representData(final Object data) {
			...
			return SafeRepresenter.this.representScalar(SafeRepresenter.this.getTag(data.getClass(), tag),
					((Enum<?>) data).name());
		}
	}
	...
	protected class RepresentUuid implements Represent {
		...
		public Node representData(final Object data) {
			return SafeRepresenter.this.representScalar(
					SafeRepresenter.this.getTag(data.getClass(), new Tag(UUID.class)), data.toString());
		}
	}
}
