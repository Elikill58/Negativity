package com.elikill58.deps.yaml.snakeyaml.external.biz.base64Coder;
...
public class Base64Coder {
	...
	public static char[] encode(final byte[] in, final int iOff, final int iLen) {
		...
		int o3;
		int o4;
		for (int ip = iOff, iEnd = iOff + iLen,
				op = 0; ip < iEnd; i0 = (in[ip++] & 0xFF), i2 = ((ip < iEnd) ? (in[ip++] & 0xFF) : 0), i3 = ((ip < iEnd) ? (in[ip++] & 0xFF) : 0), o0 = i0 >>> 2, o2 = ((i0 & 0x3) << 4
						| i2 >>> 4), o3 = ((i2 & 0xF) << 2 | i3 >>> 6), o4 = (i3 & 0x3F), out[op++] = Base64Coder.map1[o0], out[op++] = Base64Coder.map1[o2], out[op] = ((op < oDataLen)
								? Base64Coder.map1[o3]
								: '='), ++op, out[op] = ((op < oDataLen) ? Base64Coder.map1[o4] : '='), ++op) {
		}
		return out;
	}
