...
import com.elikill58.negativity.api.yaml.serializer.AnchorGenerator;
import com.elikill58.negativity.api.yaml.serializer.NumberAnchorGenerator;
...
public class DumperOptions {
	...
	public enum ScalarStyle {
		DOUBLE_QUOTED(Character.valueOf('\"')), SINGLE_QUOTED(Character.valueOf('\'')), LITERAL(
				Character.valueOf('|')), FOLDED(Character.valueOf('>')), PLAIN((Character) null);
