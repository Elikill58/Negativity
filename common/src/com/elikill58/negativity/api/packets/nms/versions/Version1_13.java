...
public class Version1_13 extends NamedVersion {
	...
	public Version1_13() {
		int i = 0;
		for (Client type : Arrays.asList(Client.TELEPORT_ACCEPT, Client.TILE_NBT_QUERY, Client.CHAT,
				Client.CLIENT_COMMAND, Client.SETTINGS, Client.TAB_COMPLETE, Client.PONG, Client.ENCHANT_ITEM,
				Client.WINDOW_CLICK, Client.CLOSE_WINDOW, Client.CUSTOM_PAYLOAD, Client.BEDIT, Client.ENTITY_NBT_QUERY,
				Client.USE_ENTITY, Client.KEEP_ALIVE, Client.FLYING, Client.POSITION, Client.POSITION_LOOK, Client.LOOK,
				Client.VEHICLE_MOVE, Client.BOAT_MOVE, Client.PICK_ITEM, Client.AUTO_RECIPE, Client.ABILITIES,
				Client.BLOCK_DIG, Client.ENTITY_ACTION, Client.STEER_VEHICLE, Client.RECIPE_DISPLAYED, Client.ITEM_NAME,
				Client.RESOURCE_PACK_STATUS, Client.ADVANCEMENTS, Client.TR_SEL, Client.BEACON, Client.HELD_ITEM_SLOT,
				Client.SET_COMMAND_BLOCK, Client.SET_COMMAND_MINECART, Client.SET_CREATIVE_SLOT, Client.STRUCT,
		...
		for (Server type : Arrays.asList(Server.SPAWN_ENTITY, Server.SPAWN_ENTITY_EXPERIENCE_ORB,
				...
				Server.SERVER_DIFFICULTY, Server.CHAT, Server.MULTI_BLOCK_CHANGE, Server.TAB_COMPLETE, Server.COMMANDS,
				Server.PING, Server.CLOSE_WINDOW, Server.OPEN_WINDOW, Server.WINDOW_ITEMS, Server.WINDOW_DATA,
				Server.SET_SLOT, Server.SET_COOLDOWN, Server.CUSTOM_PAYLOAD, Server.CUSTOM_SOUND_EFFECT,
				Server.KICK_DISCONNECT, Server.ENTITY_STATUS, Server.NBT_QUERY, Server.EXPLOSION, Server.UNLOAD_CHUNK,
				Server.GAME_STATE_CHANGE, Server.KEEP_ALIVE, Server.MAP_CHUNK, Server.WORLD_EVENT,
				Server.WORLD_PARTICLES, Server.LOGIN, Server.MAP, Server.ENTITY, Server.REL_ENTITY_MOVE,
				Server.REL_ENTITY_MOVE_LOOK, Server.REL_ENTITY_LOOK, Server.VEHICLE_MOVE, Server.OPEN_SIGN_EDITOR,
				Server.AUTO_RECIPE, Server.ABILITIES, Server.COMBAT_EVENT, Server.PLAYER_INFO, Server.LOOK_AT,
				...
				Server.TITLE, Server.STOP_SOUND, Server.NAMED_SOUND_EFFECT, Server.PLAYER_LIST_HEADER_FOOTER,
