...
public class MethodProperty extends GenericProperty {
	...
	public void set(final Object object, final Object value) throws Exception {
		if (!this.writable) {
			throw new YAMLException(
					"No writable property '" + this.getName() + "' on class: " + object.getClass().getName());
		}
	...
	public Object get(final Object object) {
		try {
			...
			throw new YAMLException("Unable to find getter for property '" + this.property.getName() + "' on object "
					+ object + ":" + e);
		}
	}
	...
	public List<Annotation> getAnnotations() {
		...
		if (this.isReadable() && this.isWritable()) {
			annotations = ArrayUtils.toUnmodifiableCompositeList(this.property.getReadMethod().getAnnotations(),
					this.property.getWriteMethod().getAnnotations());
