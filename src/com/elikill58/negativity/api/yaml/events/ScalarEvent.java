...
public final class ScalarEvent extends NodeEvent {
	...
	public ScalarEvent(final String anchor, final String tag, final ImplicitTuple implicit, final String value,
			final Mark startMark, final Mark endMark, final Character style) {
