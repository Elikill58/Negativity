...
import com.elikill58.negativity.api.yaml.constructor.Construct;
...
public class CompactConstructor extends Constructor {
	...
	protected void applySequence(final Object bean, final List<?> value) {
		try {
			final Property property = this.getPropertyUtils().getProperty(bean.getClass(),
					this.getSequencePropertyName(bean.getClass()));
	...
	public class ConstructCompactObject extends ConstructMapping {
		...
		public void construct2ndStep(final Node node, final Object object) {
			...
			if (valueNode instanceof MappingNode) {
				...
				System.out.println(
						"org.yaml.snakeyaml.extensions.compactnotation.CompactConstructor - ConstructCompactObject : unknow");
