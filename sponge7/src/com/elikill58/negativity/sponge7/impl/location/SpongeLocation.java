...
public class SpongeLocation {
	...
	public static Location toCommon(org.spongepowered.api.world.Location<org.spongepowered.api.world.World> loc){
		return new Location(com.elikill58.negativity.api.location.World.getWorld(loc.getExtent().getName(), a -> new SpongeWorld(loc.getExtent())), loc.getX(), loc.getY(), loc.getZ());
	}

	public static Location toCommon(World w, double x, double y, double z){
		return new Location(com.elikill58.negativity.api.location.World.getWorld(w.getName(), a -> new SpongeWorld(w)), x, y, z);
	}
}
