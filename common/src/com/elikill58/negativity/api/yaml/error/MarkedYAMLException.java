package com.elikill58.negativity.api.yaml.error;
...
public class MarkedYAMLException extends YAMLException {
	...
	protected MarkedYAMLException(final String context, final Mark contextMark, final String problem,
			final Mark problemMark, final String note) {
		this(context, contextMark, problem, problemMark, note, null);
	}

	protected MarkedYAMLException(final String context, final Mark contextMark, final String problem,
			final Mark problemMark, final String note, final Throwable cause) {
	...
	public String toString() {
		...
		if (this.contextMark != null && (this.problem == null || this.problemMark == null
