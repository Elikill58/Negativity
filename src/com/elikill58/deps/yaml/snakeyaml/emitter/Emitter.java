...
import com.elikill58.deps.yaml.snakeyaml.events.CollectionEndEvent;
import com.elikill58.deps.yaml.snakeyaml.events.CollectionStartEvent;
...
import com.elikill58.deps.yaml.snakeyaml.events.NodeEvent;
...
import com.elikill58.deps.yaml.snakeyaml.scanner.Constant;
...
public final class Emitter implements Emitable {
	...
	private boolean checkSimpleKey() {
		...
		return length < 128 && (this.event instanceof AliasEvent || (this.event instanceof ScalarEvent && !this.analysis.empty && !this.analysis.multiline) || this.checkEmptySequence()
	...
	private class ExpectDocumentStart implements EmitterState {
		...
		public void expect() throws IOException {
			if (Emitter.this.event instanceof DocumentStartEvent) {
				...
				final boolean implicit = this.first && !ev.getExplicit() && !Emitter.this.canonical && ev.getVersion() == null && (ev.getTags() == null || ev.getTags().isEmpty())
