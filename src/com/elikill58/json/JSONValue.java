...
public class JSONValue {
	 ...
	 * 
	 * @see com.elikill58.json.parser.JSONParser#parse(Reader)
	 ...
	 * Parse JSON text into java object from the input source.
	 * 
	 * @see com.elikill58.json.parser.JSONParser
	 * 
	 * @param in
	 * @return Instance of the following:
	 * 	org.json.JSONObject,
     ...
     * 
     * @see com.elikill58.json.JSONObject#writeJSONString(Map, Writer)
     * @see com.elikill58.json.JSONArray#writeJSONString(List, Writer)
     * 
     * @param value
     * @param writer
     */
	 ...
	 * 
	 * @see com.elikill58.json.JSONObject#toJSONString(Map)
	 * @see com.elikill58.json.JSONArray#toJSONString(List)
	 * 
	 * @param value
