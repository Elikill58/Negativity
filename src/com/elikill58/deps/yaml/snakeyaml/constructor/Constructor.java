...
import com.elikill58.deps.yaml.snakeyaml.TypeDescription;
import com.elikill58.deps.yaml.snakeyaml.error.YAMLException;
import com.elikill58.deps.yaml.snakeyaml.introspector.Property;
	...
	protected class ConstructScalar extends AbstractConstruct {
		...
		public Object construct(final Node nnode) {
			...
			try {
				...
				Object result;
				if (type.isPrimitive() || type == String.class || Number.class.isAssignableFrom(type) || type == Boolean.class || Date.class.isAssignableFrom(type) || type == Character.class
						|| type == BigInteger.class || type == BigDecimal.class || Enum.class.isAssignableFrom(type) || Tag.BINARY.equals(node.getTag())
		...
		private Object constructStandardJavaInstance(@SuppressWarnings("rawtypes") final Class type, final ScalarNode node) {
			...
			} else if (type == Byte.class || type == Short.class || type == Integer.class || type == Long.class || type == BigInteger.class || type == Byte.TYPE || type == Short.TYPE
