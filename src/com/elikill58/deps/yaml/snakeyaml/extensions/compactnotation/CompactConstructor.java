...
import com.elikill58.deps.yaml.snakeyaml.constructor.Construct;
	...
	public class ConstructCompactObject extends ConstructMapping {
		...
		public void construct2ndStep(final Node node, final Object object) {
			...
			if (valueNode instanceof MappingNode) {
				...
				System.out.println("org.yaml.snakeyaml.extensions.compactnotation.CompactConstructor - ConstructCompactObject : unknow");
				// CompactConstructor.this.applySequence(object,
				// BaseConstructor.constructSequence((SequenceNode)valueNode));
			}
		}
