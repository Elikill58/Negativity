...
public class GlobalPlayerInventory extends AbstractInventory<CheckMenuHolder> {
    ...
    public static HashMap<Player, Player> actualPlayer = new HashMap<>();

    public GlobalPlayerInventory() {
        super(NegativityInventory.GLOBAL_PLAYER, CheckMenuHolder.class);
    }

    public static void sanctionSize1(Player p, Inventory inv, List<ItemStack> sanctionItems) {
    ...
    public void openInventory(Player p, Object... args) {
        ...
        sanctionSize1(p, inv, sanctionItems);
