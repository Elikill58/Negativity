...
public class Version1_19_2 extends NamedVersion {
	...
	public Version1_19_2() {
		...
		for (Client type : Arrays.asList(Client.TELEPORT_ACCEPT, Client.TILE_NBT_QUERY, Client.DIFFICULTY_CHANGE,
				Client.CHAT_ACK, Client.CHAT_COMMAND, Client.CHAT, Client.CHAT_PREVIEW, Client.CLIENT_COMMAND,
		...
		for (Server type : Arrays.asList(Server.SPAWN_ENTITY, Server.SPAWN_ENTITY_EXPERIENCE_ORB, Server.SPAWN_PLAYER,
				...
				Server.CHAT_CUSTOM_COMPLETION, Server.CUSTOM_PAYLOAD, Server.CUSTOM_SOUND_EFFECT, Server.CHAT_DELETE,
				Server.KICK_DISCONNECT, Server.ENTITY_STATUS, Server.EXPLOSION, Server.UNLOAD_CHUNK,
				Server.GAME_STATE_CHANGE, Server.OPEN_WINDOW_HORSE, Server.INITIALIZE_BORDER, Server.KEEP_ALIVE,
