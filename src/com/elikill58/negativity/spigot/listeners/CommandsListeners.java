...
public class CommandsListeners implements CommandExecutor, TabCompleter {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] arg) {
		...
		EventManager.callEvent(new CommandExecutionEvent(label.toLowerCase(), SpigotEntityManager.getExecutor(sender), arg, prefix));
		return false;
	}

	@Override
	public List<String> onTabComplete(CommandSender sender, Command cmd, String label, String[] arg) {
		TabExecutionEvent tabEvent = new TabExecutionEvent(label.toLowerCase(), SpigotEntityManager.getExecutor(sender), arg, arg[arg.length - 1].toLowerCase(Locale.ROOT));
